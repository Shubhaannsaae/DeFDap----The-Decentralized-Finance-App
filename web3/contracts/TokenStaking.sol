...
contract TokenStaking is Ownable, ReentrancyGuard, Initializable {
    ...
    struct User {
        ...
        uint256 _stakeDays; // staking dal
    ...
    function _TokenStaking_init_unchained(
        ...
        uint256 earlyUnstakeFeePercentage_
            ...
            require(tokenAddress_ != address (0), "TokenStaking: token address cannot be address");
    ...
    function withdraw(uint256 amount) external onlyOwner nonReentrant {
        require(this.getWithdrawableAmount() >= amount, "TokenStaking: nopt enough withdrawable tokens");
